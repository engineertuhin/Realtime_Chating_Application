...
$sms=$_REQUEST['sms']; 
 ...
 $sql="INSERT INTO `massage`(`name`, `email`, `massage`, `name1`, `email1`, `ida`, `ids`,sound,images) VALUES ('$username','$useremail','$sms','$myname','$myemail','$myid','1','1','cccc')";
 $con->query($sql);
...
if(isset($_REQUEST['myid']) and isset($_REQUEST['userid'])){
 ...
 $sql="select * from massage where name='$username' and email='$useremail' and name1='$myname' and email1='$myemail' and ida='$myid' UNION  select * from massage where name='$myname' and email='$myemail' and name1='$username' and email1='$useremail' and ida='$user' order by id limit $rowlimit,10";
